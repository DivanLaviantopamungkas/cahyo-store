                        ...
                        <tr class="hover:bg-slate-50/80 dark:hover:bg-slate-900/80 transition-all group">
                            <td class="px-8 py-5">
                                <div class="flex items-center gap-3">
                                    <div class="w-2 h-2 rounded-full {{ $transaction->status == 'completed' ? 'bg-emerald-500' : 'bg-slate-300' }}"></div>
                                    <div>
                                        <p class="font-black text-slate-800 dark:text-white text-sm leading-tight">#{{ $transaction->invoice }}</p>
                                        <p class="text-[10px] font-bold text-slate-400 mt-1 uppercase">{{ $transaction->created_at->format('M d, Y • H:i') }}</p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-8 py-5">
