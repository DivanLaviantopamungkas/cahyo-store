            ...
            <div class="space-y-6">
                ...
                <div class="p-4 rounded-2xl bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 text-emerald-600 dark:text-emerald-400 mr-2"><use href="#icon-check-circle"></use></svg>
                        <p class="text-emerald-800 dark:text-emerald-300">Broadcast ini telah dikirim pada {{ $broadcast->updated_at->format('d M Y, H:i') }}</p>
                    </div>
                </div>
                @endif
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            >
                                <option value="all" {{ old('target', $broadcast->target) == 'all' ? 'selected' : '' }}>Semua Member</option>
                                <option value="active" {{ old('target', $broadcast->target) == 'active' ? 'selected' : '' }}>Member Aktif Saja</option>
                                <option value="inactive" {{ old('target', $broadcast->target) == 'inactive' ? 'selected' : '' }}>Member Nonaktif Saja</option>
                            </select>
                        </div>
